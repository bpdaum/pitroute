export function Logo({ className = "h-10" }: { className?: string }) {
    return (
        <div className={`flex items-center gap-2.5 ${className}`}>
            <svg viewBox="0 0 24 24" className="h-full w-auto drop-shadow-md" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="font-bebas text-4xl tracking-widest text-zinc-100 leading-none mt-1.5 drop-shadow-sm">
